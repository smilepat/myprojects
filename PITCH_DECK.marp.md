...
# 5개국과 경기도,
# <span class="red">현장 검증 완료.</span>

<br>

- **온디바이스 임베디드** — KERIS-Samsung Solar School Project · 아프리카 5개국 학교 배포
- **교육청 플랫폼 통합** — 경기도교육청 *하이러닝* · 2025–2026 제공 중

<br>

<span class="muted">글로벌과 국내 — 이제 Apple 생태계 위로 통합.</span>
...
- **AI 디지털교과서 (AIDT)** — 2025년 영어·수학·정보 본격 도입 (초3·4, 중1, 고1)
- **Apple Intelligence** — 한국어 정식 출시, 온디바이스 LLM 평가 가능
- **Apple School Manager** — 시도 교육청 도입 가속, 단말 일괄 관리
- **iPadOS Pencil + 음성** — 쓰기·말하기 평가 네이티브 지원

<br>

<span class="muted">2026–2030 — 정책·기술·디바이스가 동시에 정렬되는 단 한 번의 창.</span>
<span class="muted">출처: 교육부 AI 디지털교과서 정책 · aidt.keris.or.kr</span>
...
| Phase | 기간 | 산출물 |
|-------|------|--------|
| **1. Pilot** | 2026 Q3–Q4 (6개월) | 3개 학교 시범 · iPad 앱 PoC · 콘텐츠 통합 |
| **2. Region** | 2027 Q1–Q2 (6개월) | 강원도 교육청 광역 배포 · ASM 정식 연동 |
| **3. National** | 2027 Q3–2028 Q2 (12개월) | 전국 확산 · Apple 공식 EduPartner 인증 |

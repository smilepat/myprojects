...
|---|---:|---:|---:|---:|---:|---:|
| 목적 파악 | 0.05 | 0.10 | 0.50 | 0.10 | 0.25 | 1.00 |
| 심경·분위기 | 0.05 | 0.35 | 0.40 | 0.10 | 0.10 | 1.00 |
| 필자 주장 | 0.05 | 0.10 | 0.55 | 0.10 | 0.20 | 1.00 |
| 요지 파악 | 0.05 | 0.10 | 0.50 | 0.25 | 0.10 | 1.00 |
| 주제 파악 | 0.05 | 0.25 | 0.45 | 0.20 | 0.05 | 1.00 |
| 제목 추론 | 0.05 | 0.10 | 0.35 | 0.40 | 0.10 | 1.00 |
...
> **v2 (2026-05-22 calibration)**: 목적/심경/주장/요지/제목 5개 행 재산정. 트리거: C4.1 v1 검증에서 D2_Meaning 과대 선언 4건 + D4 과대 선언 1건 (심경). 자세한 근거: [synthetic-validation-c4-1-v2.md](../03-analysis/synthetic-validation-c4-1-v2.md). 결과: Kendall tau median 0.400→0.600, 도메인 모순 5→0, **PASS**.

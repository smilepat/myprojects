...
4. **KPI 측정 가능성 검증** — F1/F2/F3 각각의 이벤트 스키마 결정 ✓ ([analytics-events.md](./analytics-events.md), 2026-05-22 commit `d51d172`). 10개 이벤트 타입 × 9개 KR 매핑 완료. Week 11 베타 모집 시작 1일 전 동결.
...
5. ☐ 베타 50명 모집 채널 결정 (사용자의 기존 콘텐츠 채널 활용 가능 여부 확인)
6. ☐ Phase 2 백로그: AI Recommendation / EBS-demo 통합 / Phonics(reading-roadmap 재활성화) / Mobile / Tutor / Teacher Dashboard
7. ☐ OELP 실제 구현 레포 결정 (smilepat/oelp 신규 또는 기존 vocab-learn-pat 확장)
